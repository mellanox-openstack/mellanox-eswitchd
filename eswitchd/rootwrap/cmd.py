...
"""Root wrapper for OpenStack services
   ...
   To use this with eswitch, you should set the following in
   eswitch.conf:
   rootwrap_config=/etc/eswitch/rootwrap.conf

   You also need to let the eswitch user run eswitch-rootwrap
   as root in sudoers:
   eswitch ALL = (root) NOPASSWD: /usr/bin/eswitch-rootwrap
                                   /etc/eswitch/rootwrap.conf *
...
def main():
    ...
    possible_topdir = os.path.normpath(os.path.join(os.path.abspath(execname),
                                                    os.pardir, os.pardir))
    if os.path.exists(os.path.join(possible_topdir, "eswitch", "__init__.py")):
